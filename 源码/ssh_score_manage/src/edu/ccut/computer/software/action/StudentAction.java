...
public class StudentAction extends ActionSupport {
	...
	public String addStudent() throws Exception {
		...
		stu.setMajor(majorService.getOneMajor(student.getMid()));
...
//		System.out.println("student.getMajor().getId():"+student.getMajor().getId());
		student1.setMajor(majorService.getOneMajor(student.getMid()));
